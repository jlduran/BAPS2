...
zaptel: $(ZAPTEL_DIR)/.configured
	...
	$(ZAPTEL_DIR)/sport_interface.ko $(TARGET_DIR)/lib/modules/$(MOD_DIR)
...
echo /lib/modules/$(MOD_DIR)/sport_interface.ko: >> modules.dep
...
echo /lib/modules/$(MOD_DIR)/wcfxs.ko: /lib/modules/$(MOD_DIR)/bfsi.ko /lib/modules/$(MOD_DIR)/sport_interface.ko /lib/modules/$(MOD_DIR)/zaptel.ko >> modules.dep

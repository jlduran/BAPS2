...
# CONFIG_LIB_CGIC_FORCE is not set
...
# CONFIG_LIB_FREETYPE_FORCE is not set
# CONFIG_LIB_LIBAO_FORCE is not set
# CONFIG_LIB_LIBAUDIO_FORCE is not set
# CONFIG_LIB_LIBBFGDOTS_FORCE is not set
...
# CONFIG_LIB_LIBEXOSIP_FORCE is not set
# CONFIG_LIB_FTPLIB_FORCE is not set
# CONFIG_LIB_POPT_FORCE is not set
CONFIG_LIB_READLINE_FORCE=y
# CONFIG_LIB_SDL_GFX_FORCE is not set
# CONFIG_LIB_SDL_IMAGE_FORCE is not set
# CONFIG_LIB_SDL_TTF_FORCE is not set
# CONFIG_LIB_SDL_MIXER_FORCE is not set
# CONFIG_LIB_SDL_NET_FORCE is not set
# CONFIG_LIB_SPHINXBASE_FORCE is not set
CONFIG_LIB_SPEEX_FORCE=y
# CONFIG_LIB_SQLITE_FORCE is not set
# CONFIG_LIB_TREMOR_FORCE is not set
# CONFIG_LIB_TSLIB_FORCE is not set
# CONFIG_LIB_CRYPTOPP_FORCE is not set
# CONFIG_LIB_CONFUSE_FORCE is not set
CONFIG_LIB_UC_LIBC_TIMEZONE=y
# CONFIG_LIB_UC_LIBC_TZ_FROM_FILE is not set
...
# CONFIG_USER_BOA_SRC_BOA_NEW is not set
...
# CONFIG_USER_OPENNTPD is not set
...
# CONFIG_USER_XENOMAI is not set
...
CONFIG_USER_BUSYBOX_FEATURE_HWCLOCK_LONG_OPTIONS=y
...
CONFIG_USER_BUSYBOX_ADJTIMEX=y
...
# CONFIG_USER_BUSYBOX_FEATURE_TELNET_TTYPE is not set
# CONFIG_USER_BUSYBOX_FEATURE_TELNET_AUTOLOGIN is not set
...
CONFIG_USER_BUSYBOX_TRACEROUTE=y
...
CONFIG_USER_BUSYBOX_FEATURE_WGET_LONG_OPTIONS=y
...
CONFIG_USER_BUSYBOX_FEATURE_IPC_SYSLOG=y
CONFIG_USER_BUSYBOX_FEATURE_IPC_SYSLOG_BUFFER_SIZE=3000
CONFIG_USER_BUSYBOX_LOGREAD=y
CONFIG_USER_BUSYBOX_FEATURE_LOGREAD_REDUCED_LOCKING=y
...
# CONFIG_BLACKFIN_CHECK_POINTER is not set
# CONFIG_BLACKFIN_INSTALL_UCLINUX_CONFIG is not set
...
# CONFIG_USER_BLACKFIN_PANICTEST is not set
# CONFIG_USER_BLACKFIN_TRAPSTEST is not set
...
# CONFIG_SIMPLE_GPIO_TEST is not set
# CONFIG_USER_CRYPTOPP_LIB_EXAMPLES is not set
# CONFIG_USER_MDMA_TESTS is not set
...
# CONFIG_USER_BTSCO is not set
# CONFIG_USER_PICOCOM is not set
# CONFIG_USER_DAGRAB_DAGRAB is not set
# CONFIG_USER_CAN_EXAMPLES is not set
# CONFIG_USER_CAN_HORCH is not set
# CONFIG_USER_MDMA_KO is not set
# CONFIG_USER_SDLEXAMPLES is not set
# CONFIG_USER_DIRECTFBEXAMPLES is not set
# CONFIG_USER_CURL_CURL is not set
# CONFIG_USER_UBOOT_TOOLS is not set
...
# CONFIG_USER_MPC2X is not set

#
# Blackfin device drivers (Experimental)
#
# CONFIG_USER_BLACKFIN_DRV_PFBUTTONS is not set
# CONFIG_USER_BLACKFIN_DRV_TEA5764 is not set

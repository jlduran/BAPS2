...
1. Get the baseline BAPs uImage (contains kernel and basic root file system) and place it on your tftp server:
   ...
   http://www.rowetel.com/ucasterisk/downloads/uImage_r2.ip08[http://www.rowetel.com/ucasterisk/downloads/uImage_r2.ip08]
...
5. For more information on the IPKG format:
   ...
   http://handhelds.org/moin/moin.cgi/Ipkg[http://handhelds.org/moin/moin.cgi/Ipkg]

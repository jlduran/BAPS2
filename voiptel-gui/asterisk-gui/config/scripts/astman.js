...
var asterisk_guiappname =  "VoIPtel GUI";
var voiptel_guiversion =  "1.2.5";
var asterisk_guitools = "asterisk_guitools";
var asterisk_guitoolsversion = "0.7";
var asterisk_guiversion = "$Revision: 11425 $";
var asterisk_guifbt = 3000; // Feedback msg time
var asterisk_scriptsFolder = "/etc/asterisk/scripts/" ; /* Directory for gui scripts (graphs.sh, for example) . old: /var/lib/asterisk/scripts/*/
var asterisk_ConfigBkpPath = "/storage/gui_configbackups/" ;
//var asterisk_Sounds_path = "/var/lib/asterisk/sounds/";
var asterisk_Sounds_path = "/sounds/";
var asterisk_menusRecord_path = "/storage/sounds/record/";
...
function check_patternonfields(fields){
	...
	for (var i=0; i < fields.length; i++){
		...
		if( x.getAttribute('pattern') && !check_pattern(x.getAttribute('pattern') , x.value)   ){
			gui_alert("Invalid characters in " + fields[i] + ". Please make the necessary corrections and try again.");
			x.focus();
			return false;
		}
	}

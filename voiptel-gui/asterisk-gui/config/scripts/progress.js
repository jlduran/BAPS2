...
{	
    ...
    document.write('<span id="'+id+'Text" style="position:relative; bottom:7px">'+percentage+'%</span> <img id="'+id+'" src="images/percentImage.png" alt="'+percentage+'%" class="percentImage'+color+'" style="background-position: '+actualWidth+'px 0pt;"/>');
}
/************************************************************\
*
\************************************************************/
...
function minus ( id, percentage )
{
    ...
    var actualWidth = eval(nowWidth[0]) - eval(percentageWidth);
    var newProgress = actualWidth+'px';
    if(actualWidth<=-365) // -120
    {
        var newProgress = -365+'px'; // -120;
        $(id).style.backgroundPosition=newProgress+' 0';
        setText(id,0);
        alert('empty');
    }

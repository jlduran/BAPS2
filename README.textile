...
p{background:#fefeb4;border:1px solid #dddddd;font-weight:bold;}. This process will <b>erase your IP04 root file system</b> so please backup anything you really need (like your asterisk conf files).

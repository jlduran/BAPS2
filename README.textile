...
p{background:#fefeb4;border:1px solid #dddddd;font-weight:bold;}. This process will erase your IP04 root file system so please backup anything you really need (like your asterisk conf files).

<ol>
<li>Get the baseline BAPs uImage (contains kernel and basic root file system) and place it on your tftp server:
...
<li>Connect an RS232 cable to your IP04 (via the daughter board) and stop the boot process at the u-boot prompt.
...
# To debug post/pre inst scripts <code>#!/bin/sh -x</code> is your friend!

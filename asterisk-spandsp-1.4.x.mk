...
#   $ make -f asterisk-spandsp-1.4.x.mk
#
# Just change ASTERISK_VERSION below to build different versions
...
ASTERISK_UNZIP=zcat
TARGET_DIR=$(TOPDIR)/tmp/asterisk-$(ASTERISK_VERSION)/ipkg/asterisk-spandsp-$(ASTERISK_VERSION)
PKG_NAME:=asterisk-spandsp-$(ASTERISK_VERSION)
...
asterisk-package: asterisk $(PACKAGE_DIR)/$(PKG_NAME)_$(VERSION)_$(PKGARCH).ipk
	# kludge to get around naming conventions
